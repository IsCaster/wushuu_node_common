...
DB.prototype.getZV = function (key, type, start, end) {
    ...
    return this.redis.zrangebyscore(key, start, end).then(value => utils.transcode(value, type))
}
...
DB.prototype.zcard = function () {
    return this.redis.zcard(key, start, end)
}

DB.prototype.scard = function () {
