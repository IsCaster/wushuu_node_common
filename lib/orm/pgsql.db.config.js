...
function transformConf(conf) {
    ...
    conf.attr.map(a => {
        ...
        if (a.unique != undefined) {
            params[1][a.key].unique = a.unique
        }
        if (a.default != undefined) {
            if (a.type == "date") {
                if (a.default instanceof Date) {
                    params[1][a.key].defaultValue = a.default
                } else if (Number.isInteger(a.default)) {
                    params[1][a.key].defaultValue = new Date(a.default)
                } else {
                    params[1][a.key].defaultValue = new Date(0)
                }
...
module.exports.getOrmDB = getOrmDB